...
function getForecastFromCache(coords) {
  ...
  //Memeriksa objek caches apakah tersedia pada objek global window , jika iya, request data dari caches
  if (!('caches' in window)) {
  return null;
}
...
function updateData() {
  Object.keys(weatherApp.selectedLocations).forEach((key) => {
    ...
    // Dapat melakukan 2 panggilan, pertama ke getForecastFromNetwork() untuk mendapatkan data cuaca dari internet, 
    // kedua ke getForecastFromCache() untuk mendapatkan data cuaca dari caches:
